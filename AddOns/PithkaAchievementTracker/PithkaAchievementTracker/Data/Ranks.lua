...
PITHKA.Data.Ranks.summaries = {
	...
	['Bora pro Wipe'] = {
		text = function() return PITHKA.Data.Ranks.summaryCalc('Bora pro Wipe', {
	...
	['Hard Dungeoneers'] = {
		...
		text = function() 
			...
			{'Peasant  ||  '	.. score .. ' points', function() return true end},
			{'Knight  ||  '	    .. score .. ' points', function() return score >= 4 end}, 
			{'Baron  ||  '	    .. score .. ' points', function() return score >= 16 end},
			{'Warlord  ||  '	.. score .. ' points', function() return score >= 30 end},
			{'Undying  ||  '	.. score .. ' points', function() return score >= 45 end},
			{'Immortal  ||  '	.. score .. ' points', function() return score >= 60 end},
			{'Exitium  ||  '	.. score .. ' points', function() return score >= 77 end},
			{'Amaranth || '     .. score .. ' points', function() return score >= 94 end},
			}) end,
		tt = function() return 'RANKS\n\n'..
			'Peasant       starting rank\n'..
			'Knight         4 points\n'..
			'Baron         16 points\n'..
			'Warlord       30 points\n'..
			'Undying       45 points\n'..
			...
			'** 3 pt per Trifecta\n'..
			'** 5 pt for Unchained\n' .. 
			'IC, ROM, COS, FH, BRF not included\n' ..
			'discord.gg/HqVekRuR4h '
		end
	},
	...
	['TEAM MATES'] = {
		text = function() 
			...
			{'Devine   ||  ' .. summary, function() return ALL(dTRI) and ALL{BRP} end},
			}) end,
		tt = function() return 'RANKS\n\n'..
