...
PITHKA.Data.Achievements.DB = {
    ...
    -- DLC Dungeons
    {NAME = "White Gold Tower",     ABBV="WGT", VET = 1120,  CHA = nil,  HM = 1279, SR = 1275, ND = 1276, TRI = nil , TRINAME = nil,                      EXT = 1306, EXTNAME = "Out of the Frying Pan",  vQueue = 287,  nQueue = 288,  portID = 247, TYPE="dungeon"},
    {NAME = "Imperial City Prison", ABBV="ICP", VET = 880,   CHA = 1132, HM = 1303, SR = 1128, ND = 1129, TRI = nil , TRINAME = nil,                      EXT = 1133, EXTNAME = "Out of Sight",           vQueue = 268,  nQueue = 289,  portID = 236, TYPE="dungeon"},
    {NAME = "Ruins of Mazzatun",    ABBV="ROM", VET = 1505,  CHA = 1511, HM = 1506, SR = 1507, ND = 1508, TRI = nil , TRINAME = nil,                      EXT = 1516, EXTNAME = "Obedience Training",     vQueue = 294,  nQueue = 293,  portID = 260, TYPE="dungeon"},
    {NAME = "Cradle of Shadows",    ABBV="COS", VET = 1523,  CHA = 1529, HM = 1524, SR = 1525, ND = 1526, TRI = nil , TRINAME = nil,                      EXT = 1534, EXTNAME = "Embrace the Shadow",     vQueue = 296,  nQueue = 295,  portID = 261, TYPE="dungeon"},
    {NAME = "Falkreath Hold",       ABBV="FH",  VET = 1699,  CHA = 1942, HM = 1704, SR = 1702, ND = 1703, TRI = nil , TRINAME = nil,                      EXT = 1948, EXTNAME = "Epic Undertaking",       vQueue = 369,  nQueue = 368,  portID = 332, TYPE="dungeon"},
    {NAME = "Bloodroot Forge",      ABBV="BF",  VET = 1691,  CHA = 1941, HM = 1696, SR = 1694, ND = 1695, TRI = nil , TRINAME = nil,                      EXT = 1819, EXTNAME = "Wildlife Sanctuary",     vQueue = 325,  nQueue = 224,  portID = 326, TYPE="dungeon"},
    ...
    {NAME = "Earthen Root Enclave", ABBV="ER",  VET = 3376,  CHA = 3380, HM = 3377, SR = 3378, ND = 3379, TRI = 3381, TRINAME = "Invaders' Bane",         EXT = 3391, EXTNAME = "Scourge of Archdruid",   vQueue = 609,  nQueue = 608,  portID = 520, TYPE="dungeon"},
    ...
    {NAME = "Bal Sunnar",           ABBV="BS",  VET = 3469,  CHA = 3473, HM = 3470, SR = 3471, ND = 3472, TRI = 3474, TRINAME = "Temporal Tempest",       EXT = 3477, EXTNAME = "Infectious Beliefs",     vQueue = 614,  nQueue = 613,  portID = 531, TYPE="dungeon"},
    ...
    {NAME = "Fungal Grotto I",      VET=1556, HM = 1561,   SR = 1559,   ND = 1560,  TYPE='baseDungeon', portID=98,  nQueue=2,   vQueue=299,  n=1},
    {NAME = "Fungal Grotto II",     VET=343,  HM = 342,    SR = 340,    ND = 1563,  TYPE='baseDungeon', portID=266, nQueue=18,  vQueue=312,  n=2},
    {NAME = "Banished Cells I",     VET=1549, HM = 1554,   SR = 1552,   ND = 1553,  TYPE='baseDungeon', portID=194, nQueue=4,   vQueue=20,   n=1},
    {NAME = "Banished Cells II",    VET=545,  HM = 451,    SR = 449,    ND = 1564,  TYPE='baseDungeon', portID=262, nQueue=300, vQueue=301,  n=2},
    {NAME = "Elden Hollow I",       VET=1573, HM = 1578,   SR = 1576,   ND = 1577,  TYPE='baseDungeon', portID=191, nQueue=7,   vQueue=23,   n=1},
    {NAME = "Elden Hollow II",      VET=459,  HM = 463,    SR = 461,    ND = 1580,  TYPE='baseDungeon', portID=265, nQueue=303, vQueue=302,  n=2},
    {NAME = "City of Ash I",        VET=1597, HM = 1602,   SR = 1600,   ND = 1601,  TYPE='baseDungeon', portID=197, nQueue=10,  vQueue=310,  n=1},
    {NAME = "City of Ash II",       VET=878,  HM = 1114,   SR = 1108,   ND = 1107,  TYPE='baseDungeon', portID=268, nQueue=322, vQueue=267,  n=2},
    {NAME = "Crypt of Hearts I",    VET=1610, HM = 1615,   SR = 1613,   ND = 1614,  TYPE='baseDungeon', portID=190, nQueue=9,   vQueue=261,  n=1},
    {NAME = "Crypt of Hearts II",   VET=876,  HM = 1084,   SR = 941,    ND = 942 ,  TYPE='baseDungeon', portID=269, nQueue=317, vQueue=318,  n=2},
    {NAME = "Darkshade Caverns I",  VET=1581, HM = 1586,   SR = 1584,   ND = 1585,  TYPE='baseDungeon', portID=198, nQueue=5,   vQueue=309,  n=1},
    {NAME = "Darkshade Caverns II", VET=464,  HM = 467,    SR = 465,    ND = 1588,  TYPE='baseDungeon', portID=264, nQueue=308, vQueue=21,   n=2},
    {NAME = "Spindleclutch I",      VET=1565, HM = 1570,   SR = 1568,   ND = 1569,  TYPE='baseDungeon', portID=193, nQueue=3,   vQueue=315,  n=1},
    {NAME = "Spindleclutch II",     VET=421,  HM = 448,    SR = 446,    ND = 1572,  TYPE='baseDungeon', portID=267, nQueue=316, vQueue=19,   n=2},
    {NAME = "Wayrest Sewers I",     VET=1589, HM = 1594,   SR = 1592,   ND = 1593,  TYPE='baseDungeon', portID=189, nQueue=6,   vQueue=306,  n=1},
    {NAME = "Wayrest Sewers II",    VET=678,  HM = 681,    SR = 679,    ND = 1596,  TYPE='baseDungeon', portID=263, nQueue=22,  vQueue=307,  n=2},
    {NAME = "Arx Corinium",         VET=1604, HM = 1609,   SR = 1607,   ND = 1608,  TYPE='baseDungeon', portID=192, nQueue=8,   vQueue=305,  n=0},
    {NAME = "Blackheart Haven",     VET=1647, HM = 1652,   SR = 1650,   ND = 1651,  TYPE='baseDungeon', portID=186, nQueue=15,  vQueue=321,  n=0},
    {NAME = "Blessed Crucible",     VET=1641, HM = 1646,   SR = 1644,   ND = 1645,  TYPE='baseDungeon', portID=187, nQueue=14,  vQueue=320,  n=0},
    {NAME = "Direfrost Keep",       VET=1623, HM = 1628,   SR = 1626,   ND = 1627,  TYPE='baseDungeon', portID=195, nQueue=11,  vQueue=319,  n=0},
    {NAME = "Selene's Web",         VET=1635, HM = 1640,   SR = 1638,   ND = 1639,  TYPE='baseDungeon', portID=185, nQueue=16,  vQueue=313,  n=0},
    {NAME = "Tempest Island",       VET=1617, HM = 1622,   SR = 1620,   ND = 1621,  TYPE='baseDungeon', portID=188, nQueue=13,  vQueue=311,  n=0},
    {NAME = "Vaults of Madness",    VET=1653, HM = 1658,   SR = 1656,   ND = 1657,  TYPE='baseDungeon', portID=184, nQueue=17,  vQueue=314,  n=0},
    {NAME = "Volenfell",            VET=1629, HM = 1634,   SR = 1632,   ND = 1633,  TYPE='baseDungeon', portID=196, nQueue=12,  vQueue=304,  n=0},
} 
