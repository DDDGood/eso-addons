...
local stringsFR = {
	...
	TQG_CHAPTER_SHADOW_MORROWIND = "L’Ombre sur Morrowind",
...
TQG.GroupQuestIdToTooltip = {
	...
	[7032] = SetupGroupTooltip(GetString(TQG_TRIAL), GetString(TQG_SEEK), "Le chercheur An'Xeh"),
}