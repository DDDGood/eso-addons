local language = {
	...
	WW_MSG_IMPORTGEARENOENT = "Tous les objets n'ont pas pu être importés. Assurez-vous d'avoir tous les objets dans votre inventaire ou dans votre banque. Les traits n'ont pas d'importance.",
	...
	WW_MENU_FIXES_FIXSURFINGWEAPONS_TT = "Cela fera basculer \"cacher le casque\" deux fois à chaque échange de zone afin de corriger le bug de l'arme à vos pieds.",
	
	
	-- USER INTERFACE
	WW_CHANGELOG = "Attention! Cette mise à jour contient quelques changements majeurs. Veuillez lire le journal des modifications actuel car certaines choses peuvent maintenant fonctionner de manière differente.",
