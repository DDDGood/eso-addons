...
local PAWJewelryGrainsSubMenu = setmetatable({}, { __index = table })
...
local function _createPAWorkerMenu()
	...
	PAWorkerOptionsTable:insert({
        type = "submenu",
        name = GetString(SI_ITEMFILTERTYPE24).." "..GetString(SI_ITEMFILTERTYPE4).." ("..GetString(SI_SPECIALIZEDITEMTYPE2900)..")",   
        icon = PAC.ICONS.CRAFTBAG.JEWELCRAFTING.PATH,
        iconTextureCoords = PAC.ICONS.TEXTURE_COORDS.MEDIUM,
        controls = PAWJewelryGrainsSubMenu,
        disabledLabel = PAWMenuFunctions.AreRefineSubmenusDisabled,
    })	
...
local function _createPAWJewelryGrainsSubMenu() 
    insertTheseMatsSettings(refinableMaterials.jewelry.grains, PAWJewelryGrainsSubMenu) 
end
...
local function createOptions()
    ...
    _createPAWJewelryGrainsSubMenu()
