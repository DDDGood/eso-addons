...
local function StartDeconstructing(autoRefine)
...
local function StartCraftingInterraction(craftSkill, sameStation, craftMode, autoDeconstruct, autoRefine) 
	...
	StartDeconstructing(autoRefine) -- everything else is good so we start deconstructing
end
