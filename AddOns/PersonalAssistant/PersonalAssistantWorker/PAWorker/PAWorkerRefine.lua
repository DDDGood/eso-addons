...
local function StartRefining()
      ...
      if PAW.currentCraftingStation == "JewelryCrafting" then
	        ...
	        refinableItemsToCheck = {135137, 135139, 135141, 135143, 135145, 135151, 135152, 135153, 135154, 135160, 135158, 135159, 139420, 139419, 139417, 139415, 139416, 139418} 
