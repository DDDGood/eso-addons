...
local PAJStrings = {
    ...
    SI_PA_MENU_JUNK_AUTOMARK_INTRICATE = table.concat({"Помечать предметы с особенностью [", GetString("SI_ITEMTRAITTYPE", ITEM_TRAIT_TYPE_ARMOR_INTRICATE), "]"}),
    SI_PA_MENU_JUNK_AUTOMARK_INTRICATE_T = table.concat({"Автоматически помечать предметы с особенностью [", GetString("SI_ITEMTRAITTYPE", ITEM_TRAIT_TYPE_ARMOR_INTRICATE), "] (повышенная цена продажи) как хлам."}),
