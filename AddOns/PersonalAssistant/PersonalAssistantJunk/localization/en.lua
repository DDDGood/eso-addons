...
local PAJStrings = {
    ...
    SI_PA_MENU_JUNK_AUTOMARK_INTRICATE_T = table.concat({"Automatically mark %s with [", GetString("SI_ITEMTRAITTYPE", ITEM_TRAIT_TYPE_ARMOR_INTRICATE), "] trait (increased sell price) as junk?"}),
